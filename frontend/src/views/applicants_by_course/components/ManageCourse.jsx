...
const lastNameColumn = { Header: "Last Name", accessor: "applicant.last_name" };
const firstNameColumn = {
    Header: "First Name",
    accessor: "applicant.first_name"
};
const departmentColumn = { Header: "Department", accessor: "department" };
const yearColumn = { Header: "Year", accessor: "applicant.year" };
...
export default connect((state, props) => {
    return {
        ...
        position: findPositionByIdSelector(state, props.positionId)
    };
})(ManageCourse);
